...
{
    //sends shite like playerinfo into the server and creates player (i think)
    public class ServerHandle
    {
        ...
        //{
        //    if (!ServerSettings.CCIntegration) return;
        ...
        private static void Log(object message) => Debug.Log("[Server Handle] " + message);
    }
}