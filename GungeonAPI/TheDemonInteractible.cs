...
namespace An3sMod
{
    class TheDemonInteractible : SimpleInteractable, IPlayerInteractable
    {
        ...
        public void Interact(PlayerController interactor)
        {
            ...
            if (flag2)
            {
                ...
                if (flag4)
                {
                    ...
                    TextBoxManager.ShowTextBox(this.talkPoint.position, this.talkPoint, 2f, "Did you change your mind? too bad.", interactor.characterAudioSpeechTag, false, 0, false, false);
                }
                else
                {
        ...
        private IEnumerator HandleConversation(PlayerController interactor)
        {
            ...
            if (flag)
            {
                ...
                TextBoxManager.ShowTextBox(this.talkPoint.position, this.talkPoint, 1f, "You Wont Make it.", interactor.characterAudioSpeechTag, false, 0, false, false);
